...
**Language:** [English](../sources.md) | [日本語](sources.md) | [中文](../zh/sources.md)

# ネット調査の出所

> 様式カード・フォーマットカードの語彙を蒸留するために参照した外部ソース。カードは「生のプロンプトのコピー」でなく、これらの語彙をエンジン独自の形式（メディウム×系譜×時代／語彙／ネガティブ対）に蒸留したもの。
