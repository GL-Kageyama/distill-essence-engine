...
**フォーマット 29 種 × 様式 35 種**——全て検証済み、名前で再利用可。全索引（各カードの再利用 slug 付き）は [references/registry.md](references/registry.md)。
...
- [references/registry.md](references/registry.md) — 名前付きカードの索引（フォーマット 29 種 · 様式 35 種）
