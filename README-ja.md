...
| メディウム | 様式 |
|---|---|
| 版画・印刷 | 木版 · リノカット · 銅版画 · リソグラフ · 厳粛な台帳 |
| 手描き | 水彩 · 油絵 · 水墨画 · 手書き抽象 · 鉛筆 · 木炭 · パステル · スケッチ · マンガ線画 · クリーンラインラボ |
| デジタル | ピクセル · PS1 低ポリゴン · バウハウス系ベクター · フラットコミック · ラインナート · アイソメトリック · ダークグロー・ミニマルベクター · ハイテンション日常系コミック |
