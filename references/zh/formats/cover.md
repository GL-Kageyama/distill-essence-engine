...
**Language:** [English](../../formats/cover.md) | [日本語](../../ja/formats/cover.md) | [中文](cover.md)

# 封面（cover）

- **目的**: 象征（吸引） ／ **粒度×时间**: 单一象征 × 卷积 ／ **尺寸・比例**: 竖版 2:3・单幅
- **摘要**: 将单一象征置于竖轴，上方宽阔的留白营造出静谧与预感。

## 环境变量
`SUBJECT`＝单一象征，`TITLE`＝标题（可选）

## 构成语法
层级（立起竖轴，焦点保持小巧），上方留白宽阔
