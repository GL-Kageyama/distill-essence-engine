...
## Examples
- 午前二時に、あなたは誰の時間を生きていますか (At Two in the Morning, Whose Time Are You Living?) ep.1 → a 30-second video digest (gozen-niji-video-01) — a dark bedroom where the phone screen is the only light source, blooming softly against flat cel planes
