...
**Language:** [English](clean-line-lab.md) | [日本語](../ja/styles/clean-line-lab.md) | [中文](../zh/styles/clean-line-lab.md)

# Clean-line lab（clean-line-lab）

- **Medium**: Hand-drawn ／ **Lineage**: Textbook illustration / lab diagram ／ **Era**: —
- **Summary**: Thin precise ink lines and pale pastel flat fills hold a textbook diagram's clarity and a quiet cuteness in one restrained line language.

## Environment variables
`SUBJECT`, `ACTION`, `LOCATION`, `ACCENT`, `ASPECT`

## Fidelity anchors
- Thin precise ink lines (like a textbook experiment diagram)
- Pale pastel flat fills (mint, pale yellow, pale blue, off-white paper)
...
## Examples
- AI output needs observation → Schrödinger's cat as half-ghost/half-gold cat in a flask (ai-schrodinger-cat)

## Sources
ai-schrodinger-cat verification (0.1.19, 2026-08-23) — anti-generic 3/10 genericness, aesthetic-critic discovery_target
