...
> **2026-09-08**: **soft-flat-mascot**（やわらかい平塗りマスコット）をユーザー指示で追加。**検証待ち**（初回ケースは suica-alt-characters のイメージボード3案）。
...
| やわらかい平塗りマスコット | デジタル | 日本の交通系・自治体マスコット | ユーザー指示で追加・検証待ち（2026-09-08） | [soft-flat-mascot](styles/soft-flat-mascot.md) |
