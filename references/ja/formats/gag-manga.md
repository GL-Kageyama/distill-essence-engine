...
**Language:** [English](../../formats/gag-manga.md) | [日本語](gag-manga.md) | [中文](../../zh/formats/gag-manga.md)
...
- 4 ビートを繰り返す
- はみ出しでエネルギー
- 各登場人物の見分けがつく見た目——性別・髪型・体格・服装——を、初めて出るコマの指示文に書く。似た見た目の二人を取り違えないため（原作から導出・⑧）
