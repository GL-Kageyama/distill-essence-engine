...
- **顔は写実的に描かない（輪郭のパーツは残す）**：灯は背中・輪郭（既存ボードの人物アンカー）。店の主は「顔も名も知らない」相手だから、粉の手・押し上げる仕草を主にし、顔は輪郭のパーツだけうっすら残す（のっぺらぼうにしない）——灯が覚えているのは手触りであって顔ではない、という第1章の主題に忠実。
