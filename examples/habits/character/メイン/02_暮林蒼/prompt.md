...
- 第二巻第12話「振り向く」／第14話の頂点の一文＝`「違う読みで呼ばれて、振り向いた。」`——**返却の現場は第14話である**（run-10 は第15話とするが、**話数は run-09 を採る**。run-10 の第15話の話名は「いちばん下の一枚」である）
...
**表情4面は、四つの「段差の前」から採る。** 両手が塞がったまま、目だけを下げて段差の高さを測る（**顎は、待っている人のほうへまだ上がっていない**）／ふりがな欄を、目が読み終わるより速く打つ／名前を呼ばずに、用件から入る／**違う読みで呼ばれて、振り向いた**——ただし**足は、行き先のほうを向いたままである。** 最後の一つは、この人物がこの巻で一度だけ迎える瞬間である（`「違う読みで呼ばれて、振り向いた。」`、第14話）。振り向きかけた途中で止める。**運搬は完了しない。**
