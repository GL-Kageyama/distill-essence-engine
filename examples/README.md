...
> **Design purpose** — `poster` / `cover` / `hero` / `icon` are also Design-purpose formats (primary purpose = design); they exemplify Attraction here. **Design is a separate input axis**: its input is a brand / product / app, not content. The design cases below verify it.

**Design coverage** (input = a brand / product — distill-essence-engine itself; format-swap keeps style = Swiss fixed · style-swap keeps format = app screen fixed):

| Input ＼ Axis | App screen | Landing page | Wireframe | Brand board | Business card |
|---|---|---|---|---|---|
| Format-swap (brand × Swiss) | [design-format-app-screen](design-format-app-screen/) | [design-format-landing-page](design-format-landing-page/) | [design-format-wireframe](design-format-wireframe/) | [design-format-brand-board](design-format-brand-board/) | [design-format-business-card](design-format-business-card/) |
| Style-swap (brand × app screen) | [swiss-style](design-style-swiss-style/) · [flat-ui](design-style-flat-ui/) · [material-ui](design-style-material-ui/) · [neubrutalism](design-style-neubrutalism/) | — | — | — | — |

**FF brand-board series** — the same brand-board × Swiss treatment applied to ten real brands, one board per entry, each evoking Final Fantasy I–X through that entry's non-character motifs only. **No characters depicted anywhere** (no heroes, villains, or faces — only abstract silhouettes may appear, and only where they give the mark scale); per the user's preference each board is Swiss International Typography **with the applications section removed** — the board holds a mark (non-character motifs as flat color fields), a palette, and typography, and nothing else. No business cards, no packaging, no product mockups. The palette lives inside the mark and a single accent, never as a labeled swatch row and never as drawn color names or hex code text — the only text in the image is the headline and the English subtitle. The boards differ only in input (the brand brief); format and style stay fixed.

| Board | Core motif (no characters) | Board | Core motif (no characters) |
|---|---|---|---|
| [ff1](ff-brand-boards/ff1/) | the four crystals · darkness & light | [ff6](ff-brand-boards/ff6/) | magicite · the world of ruin |
| [ff2](ff-brand-boards/ff2/) | the wild rose · the empire | [ff7](ff-brand-boards/ff7/) | mako · the meteor · Midgar's rings |
| [ff3](ff-brand-boards/ff3/) | the crystal tower above the clouds | [ff8](ff-brand-boards/ff8/) | the garden · the moon |
| [ff4](ff-brand-boards/ff4/) | the moon · the red wings | [ff9](ff-brand-boards/ff9/) | crystal · the mist |
| [ff5](ff-brand-boards/ff5/) | the void · two seamed worlds | [ff10](ff-brand-boards/ff10/) | water · the spiral |

**Style coverage**: registered styles are **55 (all verified)**. The style-swap tests ([verify-rich/](verify-rich/)) exemplify and verify 15 new styles and 7 formats. Three styles (claymation / cyberpunk / vaporwave) were **rejected** in verification and live outside the registry (details in [verify-rich/EVALUATION.md](verify-rich/EVALUATION.md)). Dark-glow minimal vector (the proven hero family · navy + gold-orange + white-hot, four colors) was added in 0.1.17's distill-hero. High-energy slice-of-life comic (gag manga · slice-of-life anime) was added in 0.1.18's bocchan-gag-manga (Aozora Bunko "Bocchan" → 10-page manga). Clean-line lab (textbook experiment-diagram clarity × quiet cuteness) was added in 0.1.19's ai-schrodinger-cat. Six manga styles — cel-shade / shojo / webtoon soft-render / shonen battle / gekiga / manga halftone — were added in 0.1.21's melos-* style-swap cases (the first color-manga styles; manga halftone is the first printmaking-process style for comics). Seven photo / film styles — documentary photography / studio portrait / landscape photography / macro photography / cinematic still / 1970s New Hollywood / instant photo — were added in 0.1.22's melos-* style-swap cases (the first lens-and-light medium styles, completing the live-action axis beside street-photo and film-noir). Six functional-document family styles — blueprint plan / recipe how-to / circuit schematic / mechanism work / geometric construction / lab notebook — siblings of clean-line-lab that each render a concept as the style's own document (plan / steps / connection / mechanism / proof / record), were added and verified in 0.1.24's power-* style-swap cases (same input × conceptual-illustration fixed, style only swapped) and are demonstrated by the distill-* output samples below. Luminous realist anime (saturated dusk · volumetric light — the deliberate inverse of soft-cel-anime) was added in 0.1.28's melos-luminous-anime. Four design-lineage styles — Swiss / International Typographic (modular grid · flush-left grotesque · one accent), flat design (flat single-color surfaces · no gradient, no shadow), Material Design (elevation sheets · 8pt grid · one FAB), neubrutalism (thick black outlines · hard offset shadows · clashing color) — were added and verified in 0.1.30's design-* style-swap cases (same input × app screen fixed, style only swapped; a brand's fixed palette can displace the style's default accent, e.g. Swiss red → the brand's amber-gold).

**Format coverage**: registered formats are **43 (all verified)**. verify-rich/ verified and promoted 7 new ones (storyboard / poster / picture book / logo / emblem / sprite / tarot card). Hero image (hero · 16:9 banner) was added in 0.1.17's distill-hero. Gag manga (multi-panel · four-beat rhythm) was added in 0.1.18's bocchan-gag-manga. Four explanatory formats (timeline / flowchart / comparison matrix / data chart) were added in 0.1.20's attention-* cases. Eight manga formats — four-panel / webtoon / comic strip / splash page / single-panel cartoon / comic essay / reportage manga / educational manga — were added in 0.1.21's melos-* / attention-educational-manga format-swap cases. Conceptual illustration (one symbolizing image that folds a whole concept through visual metaphor / split composition / color coding) was added in 0.1.23's concept-average-vs-particular. Four anime pre-production formats — character model sheet / character image board / concept board / art board — were added in 0.1.28's gozen-niji-* cases (production references a later stage reproduces from, not pictures to enjoy). Three more anime pre-production formats — location board / key pose / action board / scene board — were added in 0.1.29's gozen-niji-* cases (the story's geography, one subject's movement vocabulary, and one scene's master staging). The **Design** purpose was added in 0.1.30 — a 7th assumed purpose whose input is a brand / product / app, not content — with 5 design formats (app screen / landing page / wireframe / brand board / business card) verified in the design-* format-swap cases (same input × Swiss style fixed, format only swapped; the brand's distillation metaphor survives each layout as its own grammar); the 7 mark cards (logo / icon / emblem / poster / cover / hero / tarot card) were reclassified to `Symbolic (design)`. The coverage matrix exemplifies 33 of the 44 registered formats (diagram / infographic / cover / icon / thumbnail / poster / picture book / manga / illustration / image board / storyboard / sprite sheet / tarot card / hero image / gag manga / episode board / timeline / flowchart / comparison matrix / data chart / conceptual illustration / character model sheet / character image board / concept board / art board / location board / key pose / action board / scene board / app screen / landing page / wireframe / brand board / business card); the manga formats are exemplified in the dedicated melos-* / attention-educational-manga cases in the case list.
...
| semantic-visual-loom-hero | semantic-visual-loom repo (sibling of the Council) | Hero image | Dark-glow minimal vector | Attraction |
...
| design-format-wireframe | The distill-essence-engine brand (brand brief) | Wireframe | Swiss / International Typographic | Design |
| design-format-brand-board | The distill-essence-engine brand (brand brief) | Brand board | Swiss / International Typographic | Design |
| design-format-business-card | The distill-essence-engine brand (brand brief) | Business card | Swiss / International Typographic | Design |
| design-style-swiss-style | The distill-essence-engine brand (brand brief) | App screen | Swiss / International Typographic | Design |
| design-style-flat-ui | The distill-essence-engine brand (brand brief) | App screen | Flat design | Design |
| design-style-material-ui | The distill-essence-engine brand (brand brief) | App screen | Material Design | Design |
| design-style-neubrutalism | The distill-essence-engine brand (brand brief) | App screen | Neubrutalism | Design |
| ff-brand-boards/ff1 | Final Fantasy I (the four crystals — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff2 | Final Fantasy II (the wild rose — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff3 | Final Fantasy III (the crystal tower — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff4 | Final Fantasy IV (the moon — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff5 | Final Fantasy V (the void — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff6 | Final Fantasy VI (magicite & the world of ruin — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff7 | Final Fantasy VII (mako & the meteor — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff8 | Final Fantasy VIII (the garden & the moon — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff9 | Final Fantasy IX (crystal & the mist — no characters) | Brand board | Swiss / International Typographic | Design |
| ff-brand-boards/ff10 | Final Fantasy X (water & the spiral — no characters) | Brand board | Swiss / International Typographic | Design |
